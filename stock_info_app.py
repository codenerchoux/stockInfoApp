...
date_range = st.sidebar.date_input('기간',value=[datetime.date(2019,1,1),datetime.date(2021,12,31)])
...
if clicked:
    ...
    with colums[1]:
      st.download_button('Excel 파일 다운로드',excel_data,file_name='excel_data.csv')
